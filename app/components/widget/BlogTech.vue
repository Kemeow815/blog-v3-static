...
const service = computed(() => ([
	...
	{ label: '图片存储', value: () => [h('img', { src: 'https://imgtg.kemeow.top/file/AgACAgUAAyEGAAScqokCAAMyaKqnSSZt88LiEVBB11OFCBTd0FkAAsTDMRupnFhVLziHo9bcQfQBAAMCAAN4AAM2BA.webp', alt: '' }), ' S3存储'] },
